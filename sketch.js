...
function setup()
{
  ...
  //  {
  //    fill("yellow")
  //  box1  = new Box(i,400,50,40)  
  //    boxGroup[j] = box1;
  //    j ++;
  //  }

  //   for (var i = 650; i < 950; i = i + 50)
  //  {
  //    //fill("red")
  //    box1 = new Box(i,360,50,40)
  //       boxGroup[j] = box1;
  //   j ++;
  //  }

  //   for (var i = 700; i < 900; i = i + 50)
  //  {
  //    //fill("purple")
  //    box1 = new Box(i,320,50,40)
  //    boxGroup[j] = box1;
  //    j ++;
  //  }

  //   for (var i = 750; i < 850; i = i + 50)
  // {
  //    // fill("pink")
  //    box1 = new Box(i,280,50,40)
  //    boxGroup[j] = box1;
  //    j ++;
  //  }

  //  for(var i = 780; i < 800; i = i + 50)
  //  {
  //    box1 = new Box(i,240,50,40)
  //    boxGroup[j] = box1;
  //    j ++;
  //  }
